	...
	return (
		<>
			<header className="p-6 min-h-[110vh] bg-no-repeat bg-cover relative flex flex-col justify-center items-center">
				...
				>
					...
					<motion.h1
						...
						initial="initial"
						animate="animate"
						className={'font-sans bg-linear-to-r from-white via-black to-white text-transparent bg-clip-text text-4xl lg:text-5xl xl:text-6xl lg:px-24 lg:w-4/5 mx-auto font-bold relative z-10'}
					>
						Discover the financial uplifiting power of <br />
			...
			>
				...
				>
					Zurvia is the DeFi finance app that empowers you to live off
					of DeFi, without selling it.
				</motion.p>
				...
				<div className="flex flex-col gap-24 md:px-24 mt-6 lg:gap-24">
					<div className="flex flex-col gap-4 md:flex-row lg:gap-20">
						...
						<div className="lg:w-2/5 flex flex-col gap-2 lg:gap-4 mt-4 lg:mt-0 justify-center">
							...
							<p className="text-default-text lg:text-">
								Unlock liquidity in minutes without selling your
								DeFi. View your loan status, track your
								collateral ratio, and manage risk, all directly
								in the Zurvia app. Stay in control with
								real-time insight into your position.
							</p>
						</div>
					</div>
					...
					<div className="flex flex-col gap-4 md:flex-row-reverse lg:gap-20">
						...
						<div className="lg:w-2/5 flex flex-col gap-2 lg:gap-4 mt-4 lg:mt-0 justify-center">
							...
							<p className="text-default-text lg:text-">
								Your Zurvia wallet gives you a complete view of
								your DeFi-powered portfolio—BTC, MUSD, mats,
								NFTs, and more—all in one place. No complexity,
								no confusion. Just a clear, seamless portal to
								your onchain wealth.
							</p>
						</div>
					</div>
					...
					<div className="flex flex-col gap-4 items-center justify-center text-center lg:flex-col-reverse">
						...
						<div className="flex flex-col gap-4">
							...
							<p className="text-default-text font-ibm_plex_sans">
								This is where your DeFi gets busy. Earn yield,
								vote on Zurvia’s future, add liquidity, and much
								more, all from one place. It’s your home base
								for using DeFi, not just holding it.
							</p>
						</div>
					</div>
				</div>

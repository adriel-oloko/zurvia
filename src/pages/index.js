        ...
        <>
            ...
            <header className="p-6 min-h-[110vh] bg-no-repeat bg-cover relative flex flex-col justify-center items-center">
                ...
                <nav className="flex justify-between items-center w-full absolute p-6 top-0 z-50">
                    <Image src={'/logo.svg'} className="w-24 md:w-32 relative -top-0.5" width={83} height={24} alt="Logo" />
                    ...
                    <div>
                        <button name="Toggle navigation menu" aria-label="Toggle navigation menu" onClick={() => (mobileNav ? setMobileNav(false) : setMobileNav(true))} className="lg:hidden">
                            {mobileNav ? (
                                <svg xmlns="http://www.w3.org/2000/svg" height="32px" viewBox="0 -960 960 960" width="32px" fill="000" className="relative top-1 size-7">
                ...
                <div className="absolute z-20 w-full top-28 md:w-4/6 mx-auto md:top-32">
                    <div className="w-3/5 mx-auto flex justify-between">
                        <div initial="initial" animate="animate" className="size-10 bg-white rounded-lg flex items-center justify-center shadow-md top-0 inset-x-0 mx-auto">
                            <ShieldCheck />
                        </div>
                        <div className="size-10 bg-white rounded-lg flex items-center justify-center shadow-md top-0 inset-x-0 mx-auto">
                            <RefreshCw />
                        </div>
                    </div>
                ...
                <section onClick={isClient ? screenTap : undefined} className="text-center flex flex-col gap-4 items-center -mt-24 md:mt-24 relative">
                    <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }} className="rounded-full bg-white/10 backdrop-blur-sm px-4 py-2 font-medium font-inter shadow-md shadow-[#f7931a10]">
                        100% transparent
                    </motion.p>

                    <h1 className={'font-ibm_plex_sans bg-linear-to-r from-white via-black to-white text-transparent bg-clip-text text-4xl lg:text-5xl xl:text-6xl lg:px-24 lg:w-4/5 mx-auto font-bold relative z-10'}>
                    ...
                    <p className="text-default-text text-xl font-inter">Bring everyday finance to your portfolio</p>
                    <motion.section initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3, delay: 0.2 }} className="grid grid-cols-2 w-fit gap-2">
            ...
            <section className="bg-white py-24 flex flex-col gap-16 lg:py-24">
                <h2 className="text-center font-ibm_plex_sans uppercase text-default-text text-sm">Friends who share our vision</h2>

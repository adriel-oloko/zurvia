            ...
            {isLoading ? (
                ...
                <>
                    <header className="p-6 min-h-[110vh] bg-no-repeat bg-cover relative flex flex-col justify-center items-center">
                        <Image
                            src={'/gradient-bg-GgcszqHZ.webp'}
                            className="absolute inset-0 border-2 border-solid border-red-500 min-h-full object-cover"
                            width={2298}
                            height={993}
                            priority
                            quality={85}
                    ...
                    <motion.section
                        ...
                        <div className="relative px-6 pt-12 pb-80 rounded-3xl w-full bg-no-repeat text-center lg:px-24 lg:pt-12 bg-cover bg-center flex flex-col gap-4">
                            <Image
                                src={'/maze-background-DNA5qxlH.webp'}
                                className="absolute inset-0 h-full object-cover object-center rounded-3xl"
                                width={1440}
                                height={652}
                                alt=""
                            />

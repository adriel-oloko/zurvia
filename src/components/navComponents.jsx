    ...
    return (
        <div className="relative">
            ...
            <button
                ...
                className="text-black fill-black px-4 py-2 rounded-full hover:bg-black hover:text-white hover:fill-white font-inter font-semibold hover:transition-colors flex focus:bg-black/5 focus:hover:bg-black">
                {text}
                {children && (
                    <svg
                        ...
                        width="28px"
                        className="rotate-90 relative -top-0.25 -right-1.75">
            ...
            {children && (
                <div
                    ref={childElemRef}
                    className="MnUDrkYKud absolute bg-white border border-solid border-gray-200 shadow shadow-gray-200 rounded z-10 left-4 top-14 p-2 flex gap-2 flex-nowrap opacity-0 transition-all duration-500 invisible">
                    {children.map((child, index) => {
                        return (
                            <a
                                key={index}
                                href={child.href}
                                className="text-black font-semibold text-nowrap flex items-center p-2 rounded hover:bg-gray-50">
                                {child.label}{' '}
                                {icon && (
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        width="24px"
                                        fill="000"
                                        className="-rotate-45 relative top-0.25">
                                    ...
                                    <svg
                                        ...
                                        className={`${
                                            visibleIndex === index
                                                ? '-rotate-90'
                                                : 'rotate-90'
                                        } transition-all relative top-0.25`}>
                                        <path d="M504-480 348-636q-11-11-11-28t11-28q11-11 28-11t28 11l184 184q6 6 8.5 13t2.5 15q0 8-2.5 15t-8.5 13L404-268q-11 11-28 11t-28-11q-11-11-11-28t11-28l156-156Z" />
                                    </svg>
                                </button>
                            </div>
